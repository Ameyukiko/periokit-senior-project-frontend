  ...
  <aside :class="[
      ...
      >
        ...
        >
          ...
          <div class="mt-2 pt-2 border-t border-slate-100">
            <h4 class="text-[8px] font-black text-slate-800 uppercase tracking-wider mb-1.5">Furcation involvement</h4>
            <div class="space-y-1">
          ...
          <div class="mt-2 pt-2 border-t border-amber-100">
            <div class="flex items-center gap-1.5">
              <div class="relative w-3 h-3">
                ...
                <span class="absolute inset-0 flex items-center justify-center text-[5px] font-bold text-amber-900">K</span>
              </div>
              <span class="text-[8px] font-medium text-slate-400">= KTW &lt; 2mm (inadequate)</span>
            </div>
          </div>
    ...
    <template v-else>
      <div class="bg-white rounded-2xl border border-slate-200 p-3 shadow-sm">
        ...
        <!-- Section 2: Furcation involvement -->
        <div class="border-t border-slate-100 pt-3">
          <h3 class="text-[9px] font-black text-slate-800 uppercase tracking-widest mb-2">Furcation involvement</h3>
        ...
        <div class="border-t border-amber-100 pt-3 mt-3">
          <div class="flex items-center gap-1.5">
            ...
            <span class="text-[9px] font-bold text-slate-400">= KTW &lt; 2mm (inadequate)</span>
          </div>
        </div>
